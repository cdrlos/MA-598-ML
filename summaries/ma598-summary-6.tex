...
% explain how the size of a convolutional neural network would grow if it were
% to maintain the frame conditions, and provide preliminary experimental results
% with a new architecture with a design based on their framework.
% The authors set out to answer some of the following questions:
% \begin{enumerate}[1.]
% \item What is the role of the filter channels in convolutional layers?
% \item Why do some networks need fully connected layers whereas others do not?
% \item What is the role of the nonlinearity such as ReLU?
% \item Why do we need pooling and unpooling in some architectures?
% \item What is the role of a bypass connection or residual network?
% \item How many layers do we need?
% \end{enumerate}
...
% promising direction in the study of determining why neural networks work; it
% is a very deep synthesis of classical methods of $X$-let/compressive sensing
% based image processing and modern methods of AI based image processing.
